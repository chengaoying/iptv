...
public class AddOrderForMerResponseVO  extends cn.com.do1.ebusiness.exinterface.vo.response.xsd.BaseResponseVO  implements java.io.Serializable {
    private java.lang.String orderDates;

    private java.lang.String orderIds;

    public AddOrderForMerResponseVO() {
    }
    ...
    /**
     * Gets the orderDates value for this AddOrderForMerResponseVO.
     * 
     * @return orderDates
     */
    ...
    /**
     * Sets the orderDates value for this AddOrderForMerResponseVO.
     * 
     * @param orderDates
     */
    ...
    /**
     * Gets the orderIds value for this AddOrderForMerResponseVO.
     * 
     * @return orderIds
     */
    ...
    /**
     * Sets the orderIds value for this AddOrderForMerResponseVO.
     * 
     * @param orderIds
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AddOrderForMerResponseVO)) return false;
        AddOrderForMerResponseVO other = (AddOrderForMerResponseVO) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AddOrderForMerResponseVO.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://response.vo.exinterface.ebusiness.do1.com.cn/xsd", "AddOrderForMerResponseVO"));
