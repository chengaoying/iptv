...
<script>
	...
	//从webservice获取商家信息
	function findMerchants(merchantCode){
	...
	findBrands("${brand.brandCode}");
	findMerchants("${brand.merchantCode}");
</script>
</head>
<body>
<form action="<%=path %>/merbrand.do?method=updateMerbrand" method="post" name="form1" id="form1">
<input type="hidden" name="bid" id="bid" value="${brand.bid}" />
 <div class="font01">
  <table width="100%" id="table_add">
    <tr id='table01'>
      <td width="30%">&nbsp;</td>
      <td width="8%" align="left">商品品牌:</td>
      <td width="22%" align="left">
      <select id="brandCode" name="brandCode" onchange="setSelName('brandName', this)" style="width:150px">
      	<option value="">--请选择--</option>
      </select>
      <input type="hidden" name="brandName" id="brandName" value="${brand.brandName}" />
      </td>
    ...
    <tr id='table01'>
      ...
      <td width="22%" align="left"><input name="merbrandCode" type="text" id="merbrandCode" size="30" value="${brand.merbrandCode}" /></td>
      <td width="10%" align="left"><span style="color: #FF0000">*</span></td>
      <td width="30%">&nbsp;</td>
    </tr>
    <tr id='table01'>
      ...
      <td width="22%" align="left"><input name="merbrandName" type="text" id="merbrandName" size="30" value="${brand.merbrandName}" /></td>
    ...
    <tr id='table01'>
      ...
      <input type="hidden" name="merchantName" id="merchantName" value="${brand.merchantName}" />
	  </td>
      <td width="10%" align="left"><span style="color: #FF0000">*</span></td>
      <td width="30%">&nbsp;</td>
    </tr>
    <!--tr id='table01'>
      ...
      <td width="22%" align="left"><input name="merchantCode" type="text" id="merchantCode" size="30" value="${brand.merchantCode}" /></td>
      <td width="10%" align="left"><span style="color: #FF0000">*</span></td>
      <td width="30%">&nbsp;</td>
    </tr>
    <tr id='table01'>
      ...
      <td width="22%" align="left"><input name="merchantName" type="text" id="merchantName" size="30" value="${brand.merchantName}" /></td>
      <td width="10%" align="left"></td>
      <td width="30%">&nbsp;</td>
    </tr-->
    <tr id='table01'>
      ...
      <td width="22%" align="left"><textarea name="memo" cols="32" rows="4" id="memo">${brand.memo}</textarea></td>
      <td width="10%" >&nbsp;</td>
      <td width="30%">&nbsp;</td>
    </tr>
	<tr id='table01'>
